...
Open the public app, register, verify email, and sign in. Connect [ChatGPT](../clients/chatgpt.mdx) and [Claude](../clients/claude.mdx) to `https://your-public-origin/mcp`. Run the [authentication checks](./validation.mdx) against the deployed origin before sharing it. Use a stable hostname and durable database/key backups for a lasting deployment.
