...
Start a chat with the app enabled and ask: “Call get_random_number once and return the tool result.” The only tool calls the API and returns an integer from 0 through 100. OAuth consent and an actual tool call were verified on the [Jio deployment](../guides/validation.mdx).
