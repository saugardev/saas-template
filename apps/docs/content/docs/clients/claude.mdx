...
The web OAuth flow and actual tool call were verified on the [Jio deployment](/docs/guides/validation). See [Claude's custom connector guide](https://support.claude.com/en/articles/11175166-get-started-with-custom-connectors-using-remote-mcp) for current UI availability.
